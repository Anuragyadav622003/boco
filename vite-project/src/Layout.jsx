    ...
    <div className="">
      ...
      <div className="flex justify-between md:justify-evenly items-center relative">
        ...
        <div className="hidden md:flex justify-evenly border border-gray-300 rounded-full text-md text-indigo-900 font-bold p-2 w-1/2">
          <Link to="/boco-shopify-store-build" className="text-indigo-900">Shopify Store Build</Link>
          <Link to="/custom-shopify-landing-page" className="text-indigo-900">Landing Page Design</Link>
          <Link to="/case-studies" className="text-indigo-900">Case Studies</Link>
        </div>
      ...
      >
        <Link to="/boco-shopify-store-build" className="text-indigo-900" onClick={() => setMenuOpen(false)}>Shopify Store Build</Link>
        <Link to="/custom-shopify-landing-page" className="text-indigo-900" onClick={() => setMenuOpen(false)}>Landing Page Design</Link>
        <Link to="/case-studies" className="text-indigo-900" onClick={() => setMenuOpen(false)}>Case Studies</Link>
      </div>
</div>
      {/* Page Content */}
      <div className="">
